...
<div id="wrapper">
	...
	<div id="content-wrapper">
		...
		<div id="content">
			...
			<p>We expect competitors to be familiar with a Linux command line (you will have an option between <i>bash</i>, <i>zsh</i>, and <i>csh</i>. Our provided workstations will also give you <i>vim</i>, <i>emacs</i>, and various graphical editors such as <i>Eclipse</i> and <i>gedit</i>. We will also provide compilation tools for <b>Java</b>, a complete <b>Python 2.7</b> environment, as well as <b>gcc for C, C++</b> and all the other languages it compiles. Sample game clients will be provided in <b>Python and Java</b>, but you are free to use any language capable of communicating with our API.</p>
